...
\bibitem{multiplex} Ostoic, J.A.R. ~\textbf{multiplex}: \emph{Analysis of Multiple Social Networks with Algebra}. R package version 1.6
%
\end{thebibliography}
