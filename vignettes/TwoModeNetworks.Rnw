...
bmgraph(frt, layout = "stress", seed = 1, cex = 3, tcex = .7, vcol = 8, pch = 16:15)
@
...
\bibitem{multiplex} Ostoic, J.A.R. ~\textbf{multiplex}: \emph{Algebraic Tools for the Analysis of Multiple Social Networks}. R package v 2.2
\bibitem{multiplex} Ostoic, J.A.R. ~\textbf{multigraph}: \emph{Plot and manipulate multigraphs}. R package v 0.40
%
\end{thebibliography}
